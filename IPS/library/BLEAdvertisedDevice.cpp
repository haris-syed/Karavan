...
int BLEAdvertisedDevice::getTimesFound(){
	return timesFound;
}


void BLEAdvertisedDevice::setTimesFound(int tf) {
	timesFound = tf;
} // setAddress

void BLEAdvertisedDevice::addValue(int v) {
	values[timesFound] = v;
}
int* BLEAdvertisedDevice::getValues() {
	return values;
}
