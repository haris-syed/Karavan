...
private:
	...
	/***************************************/
	int timesFound = 0; //counter for times a device was found
	void setTimesFound(int tf); 
	int values[20]; //array for values...max is usually 20
	void addValue(int v); //add value to array
